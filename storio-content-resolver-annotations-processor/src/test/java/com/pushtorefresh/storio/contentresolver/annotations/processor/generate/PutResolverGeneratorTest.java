...
import static com.pushtorefresh.storio.contentresolver.annotations.processor.generate.TestFactory.createElementMock;
...
public class PutResolverGeneratorTest {
    ...
    @Test
    public void ignoreNullsShouldAddCheckIfObject() throws IOException {
        final StorIOContentResolverType storIOContentResolverType = mock(StorIOContentResolverType.class);
    ...
    @Test
    public void ignoreNullsShouldNotAddCheckIfPrimitive() throws IOException {
        final StorIOContentResolverType storIOContentResolverType = mock(StorIOContentResolverType.class);
        ...
        final StorIOContentResolverColumnMeta storIOContentResolverColumnMeta2 = createColumnMetaMock(
                createElementMock(INT),     // primitive!
                "column2",
                "column2Field",
                false,
                true,
        ...
        checkFile(out.toString(),
                ...
                PART_MAP_TO_INSERT_QUERY_WITH_COMMON_URI,
                PART_MAP_TO_UPDATE_QUERY_WITH_COMMON_URI,
                PART_MAP_TO_CONTENT_VALUES_WITHOUT_NULL_CHECK); // Without check
    }
